...
Este projeto foi desenvolvido pelo Estudante Renan Homem Cunha no curso de Desenvolvimento Web Full-Stack da [Trybe](https://www.betrybe.com/) na 18ª semana de curso.

# Habilidades
Neste projeto, foram exigidas as seguintes habilidades:
...
Neste projeto foi desenvolvido uma carteira de controle de gastos com conversor de moedas, ao utilizar essa aplicação um usuário será capaz de:
...
1. Clone o repositório
  * `git clone git@github.com:renanhcunha/trybewallet.git`.
...
Para realizar a busca de câmbio de moedas foi utilizada a API do _awesomeapi.

Se você quiser saber mais informações sobre a API, veja a [documentação](https://docs.awesomeapi.com.br/api-de-moedas).
